                ...
                for (int i = 0; i <= QTDOPM; i++) {
                    Ion.with(context).load(LotacoesEnderecos)
                        ...
                        public void onCompleted(Exception e, JsonArray result) {
                            ...
                            Log.d("updateUnidadesPMAM ", result.toString());
                        }
                    });
                    try {
                        Thread.sleep(2000);
                    ...
                    if (i == QTDOPM) {
                        if (qtdErros > 0) {
                            int ta = (QTDOPM * 5) - (qtdErros * 5);
                            int te = qtdErros * 5;
                            retorno = String.format("Atualizado com sucesso: %d Unidades", ta)
                                    + String.format("\nErro durante atualização: %d Unidades", te);
                        } else {
